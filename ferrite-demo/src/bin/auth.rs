...
type Subscription = Rec <
  ExternalChoice < SubscribeAction >
>;
...
pub fn create_authenticated_pub_sub
  () ->
    SharedSession < AuthenticatedPubSub >
{
  todo!()
}
