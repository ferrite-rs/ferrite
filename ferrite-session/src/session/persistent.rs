...
where
  P : Protocol,
{
  new_session : Arc<dyn Fn() -> Session<P> + Send + Sync>,
}

impl<P> Clone for PersistentSession<P>
where
  P : Protocol,
{
  fn clone(&self) -> Self
...
pub fn create_persistent_session<F, P>(f : F) -> PersistentSession<P>
where
  P : Protocol,
